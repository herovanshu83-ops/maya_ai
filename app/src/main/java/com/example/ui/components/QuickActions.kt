...
fun QuickActions(
    ...
    val actions = listOf(
        ...
        QuickActionItem("Play Lo-Fi", "Play lo-fi on YouTube", Icons.Default.PlayArrow, Color(0xFFEF4444)),
        QuickActionItem("Set 7 AM Alarm", "Set alarm for 7 AM", Icons.Default.Alarm, Color(0xFFA855F7)),
        QuickActionItem("Device Info", "Show device info", Icons.Default.Smartphone, Color(0xFF64748B))
    )
